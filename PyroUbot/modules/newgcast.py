...
__HELP__ = f"""
<b>⦪ ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ɢᴄᴀsᴛ ɴᴇᴡ ⦫</b>
<blockquote>
⎆ perintah:
ᚗ <code>{0}gc</code> query balas pesan

⎆ Query :
ᚗ gc[grup], adm[khusus admin], pv [private chat]</blockquote>
...
async def _(c, m):
    ...
    try:
        ...
        await m.reply(f"<emoji id =5929358014627713883>❌</emoji>**mohon gunakan gc /adm/pv balas ke pesan**")
