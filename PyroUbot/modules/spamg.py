...
⎆ perintah:
ᚗ <code>{0}spam</code>
⊶ melakukan spam pesan

ᚗ <code>{0}setdelay</code>
⊶ mengatur delay setiap pesan yang di kirim

ᚗ <code>{0}stopspam</code>
⊶ memberhentikan spam pesan yang sedang berjalan</blockquote>
"""
